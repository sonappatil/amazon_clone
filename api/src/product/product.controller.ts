...
export class ProductController {
    ...
    findAllProducts(): Promise<ProductDocument[]>{
        return this.productService.finALL();
    }
   ...
   @UseGuards(JwtGuard)
    ...
    @Patch(':id')
    update(@Param('id') id:string,@Param('name') name: string, @Param('price') price:number, @Param('description') description:string):Promise<ProductDocument>{
